    ...
    <KeyboardAvoidingView style={styles.flex} behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
      <ScrollView contentContainerStyle={styles.container} keyboardShouldPersistTaps="handled">
        <View style={styles.hero}>
          ...
          <Text style={styles.heroSubtitle}>Track, share, and plan your money together.</Text>
          <View style={styles.tagsRow}>
            <Text style={styles.tag}>💕 Couples</Text>
            <Text style={styles.tag}>🏠 Family</Text>
            <Text style={styles.tag}>✈️ Trips</Text>
          </View>
        </View>

        <View style={styles.card}>
          <Text style={styles.kicker}>Welcome back</Text>
          <Text style={styles.cardTitle}>Login to your wallet</Text>
          <Text style={styles.cardSubtitle}>Continue managing your personal and shared budgets.</Text>
